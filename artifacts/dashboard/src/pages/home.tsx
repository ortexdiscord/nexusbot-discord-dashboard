      ...
      >
        ...
        <div className="relative z-10 text-center space-y-7 max-w-sm w-full px-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-[11px] text-purple-300/40 text-center leading-relaxed px-2">
              Only reads your username &amp; servers — no messages, no DMs, no passwords. Uses official Discord OAuth2.
            </p>
          </div>
        </div>
      </div>
